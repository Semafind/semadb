...
func (v *indexVamana) insertWorker(ctx context.Context, pc cache.ReadWriteCache, jobQueue <-chan cache.GraphNode, wg *sync.WaitGroup, cancel context.CancelCauseFunc) {
	defer wg.Done()
